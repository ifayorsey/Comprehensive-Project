...
In the case of analyzing text, there are 171,476 words in the English language, making natural language processing a difficult task when dealing with its large volume. In this paper, I look to find the most computationally efficient methods of analyzing natural language.
